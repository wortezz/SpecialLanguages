...
class ColorUtils:
    ...
    def _load_colors(self):
        with open('../Lab5/config/colors.json', 'r', encoding="utf8") as file:
            data = json.load(file)
    ...
    def choose_color(self):
        print("Виберіть колір для ASCII-арту (натисніть Enter для стандартного кольору):")
        ...
        if color_choice.isdigit() and 1 <= int(color_choice) <= len(color_keys):
            ...
            print("Використано стандартний колір.")
